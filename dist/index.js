...
var plugin = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        ...
                        var method = function (window) { return complete(window, timeout); };
    ...
    plugin.prototype.retreiveWindow = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var current_window, i, pathlength, iterable, item, slot;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        item = typeof iterable === 'string' ? { display: iterable } : iterable;
                        slot = this.retreiveSlot(current_window, item);
                        if (!slot) return [3 /*break*/, 4];
                        ((_a = item.options) === null || _a === void 0 ? void 0 : _a.hotbar) ? this.clickHotbarSlot(slot) : this.clickSlot(current_window, slot, item.options);
                        return [4 /*yield*/, this.windowEvent(item.options)];
                    case 3:
    ...
    plugin.prototype.retreiveItem = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var path_reference, element, window, item, slot;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(typeof prismarine_item_1.Item);
                    ...
                    case 1:
                        ...
                        if (window && element && !(element instanceof prismarine_windows_1.Window)) {
                            item = typeof element === 'string' ? { display: element } : element;
                            slot = this.retreiveSlot(window, item);
                            if (slot) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (window && element && !(element instanceof prismarine_windows_1.Window)) {
                            ...
                            slot = this.retreiveSlot(window, item);
                            if (slot) {
                                ((_a = item.options) === null || _a === void 0 ? void 0 : _a.hotbar) ? this.clickHotbarSlot(slot) : this.clickSlot(window, slot, item.options);
